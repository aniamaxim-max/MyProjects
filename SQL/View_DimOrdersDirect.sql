IF EXISTS(SELECT name FROM sys.views WHERE name = 'v_DimOrdersDirect' AND type = 'V')
    DROP VIEW v_DimOrdersDirect
GO

CREATE VIEW dbo.v_DimOrdersDirect AS
WITH cte AS
    (
    ...
    ON _Document650._Fld17685RRef = Statments._IDRRef
